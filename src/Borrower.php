...
class Borrower
{
    ...
    public function borrow(Asset $asset)
    {
        ...
        if(in_array($asset,$notExpired)) throw new BorrowerException("You cannot borrow this item, you already have it.");
        if(count($notExpired) >= 5) throw new BorrowerException("You cannot borrow this item because you already have 5 other items.");
    ...
    {
        if(!in_array($asset,$this->currentBorrowingList)) throw new BorrowerException("You cannot send back this item, you don't have it.");
